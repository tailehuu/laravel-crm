...
@section('content')
    ...
    <div class="form-horizontal">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-5 control-label load-left">Prospect/Customer Name</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" required name="customer_name" value="{{ $sale->customer_name}}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-5 control-label load-left">Opportunity Name</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" required name="opportunity_name" value="{{ $sale->opportunity_name}}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-5 control-label load-left">Opportunity Type</label>
                    <div class="col-sm-7">
                        <select class="form-control select-value" name="opportunity_type">
                            @foreach ($opportunityTypes as $key => $opportunityType)
                                ...
                                @else
                                    <option value="{{ $key }}">{{ $opportunityType }}</option>
                                @endif
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-5 control-label load-left">Engagement Type</label>
                    <div class="col-sm-7">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="number" class="form-control" required name="head_count" value="{{ $sale->head_count }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="number" class="form-control" required name="value" value="{{ $sale->value }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-5 control-label load-left">Duration (month)</label>
                    <div class="col-sm-7">
                        @if($sale->probability == 100)
                            <input type="number" class="form-control" disabled="disabled" required name="duration" value="{{ $sale->duration }}">
                        @else
                            <input type="text" class="form-control" required name="duration" value="{{ $sale->duration }}">
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-5 control-label load-left">Probability (%)</label>
                    <div class="col-sm-7">
                        <input type="number" data-fv-integer-message="The value is not an integer" class="form-control"
                    ...
                    <div class="col-sm-7">
                        <div class="input-group date" id="dp3">
                            <input class="form-control" type="text" required name="closure_date"
                                   value="{{ $sale->closure_date }}"> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-5 control-label load-left">Start Date</label>
                    <div class="col-sm-7">
                        <div class="input-group date" id="dp3">
                            <input class="form-control" type="text" required name="started_at"
                                   value="{{ $sale->started_at }}"> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" data-fv-integer-message="The value is not an integer"
                                       class="form-control" required name="value{{ $key + 1 }}"
                                       value="{{ $value->value }}">
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-5 control-label load-left">Description</label>
                    <div class="col-sm-7">
                        <textarea rows="4" class="form-control" name="description" maxlength="500">{{ $sale->description }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="col-sm-7">{{ Form::submit('Submit', array('class' => 'btn btn-primary')) }}</div>
            </div>
        </div>
    </div>
