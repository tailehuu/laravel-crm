    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="number" data-fv-numeric-message="" required class="form-control required"
                           name="head_count">
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="inputPassword3" class="col-sm-5 control-label">Probability
                    %</label>
                <div class="col-sm-7">
                    <input type="number" data-fv-integer-message="The value is not an integer" required
                           class="form-control" name="probability">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea rows="4" class="form-control" name="description" maxlength="500"></textarea>
                </div>
            </div>
        </div>
    </div>
